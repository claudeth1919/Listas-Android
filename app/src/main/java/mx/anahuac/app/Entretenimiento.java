...
public class Entretenimiento extends AppCompatActivity {
    int [] IMAGES = {R.drawable.cine, R.drawable.cinemex, R.drawable.ruta};
    String [] NAMES = {"Cinépolis","Cinemex","Ruta 66"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Entretenimiento.CustomAdapter customAdapter = new Entretenimiento.CustomAdapter();
